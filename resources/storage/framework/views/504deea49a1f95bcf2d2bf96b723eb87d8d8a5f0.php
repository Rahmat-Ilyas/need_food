                                ...
                                <div class="box-keranjang">
                                    <div class="row">
                                        <div class="col-lg-8">
                                              <div class="row">
                                                  <div class="col-lg-6">
                                                      <img src="<?php echo e(asset('page/assets/images/product/shabu.jpg')); ?>" class="img-keranjang">
                                                  </div>
...
<?php echo $__env->make('headfood.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kesiniku1\resources\resources\views/page/keranjang/index.blade.php ENDPATH**/ ?>