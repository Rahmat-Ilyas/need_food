<?php $__env->startSection('homes'); ?>
<header>
    <div class="single-banner">
        <div class="banner-img">
            <img src="<?php echo e(asset('page/assets/images/image_jumbroton.png')); ?>" alt="" srcset="">
        </div>
        <div class="container">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <img src="<?php echo e(asset('page/assets/images/background_titik.png')); ?>" alt="" srcset=""
...
<section class="service">
    ...
    <div class="container">
        <div class="row box_card">
            <div class="col-md-6">
                <img src="<?php echo e(asset('page/assets/images/home_service.png')); ?>" class="img_service" alt="">   
                <img src="<?php echo e(asset('page/assets/images/home_service_mini.png')); ?>" class="img_service_mini" alt="" srcset="">
            ...
            <div class="col-md-6">
                <img src="<?php echo e(asset('page/assets/images/food_stall.png')); ?>" class="img_service" alt="">
                <img src="<?php echo e(asset('page/assets/images/food_stall_mini.png')); ?>" class="img_service_mini" alt="">
               <p class="text_service mt-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse tellus consectetur nulla turpis at justo, </p>  
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-4">
            <div class="box_testimoni">
               ...
               <div class="row footer_box_testi">
                    <div class="container">               
                        <img src="<?php echo e(asset('page/assets/images/user.png')); ?>" class="rounded-circle img_testi">
...
<section class="saran_masukan">
    <div class="container">
        <div class="row">
            ...
            <img src="<?php echo e(asset('page/assets/images/background_titik.png')); ?>" class="img-saran" alt="">
            </div>
...
<?php echo $__env->make('headfood.pagelanding', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kesiniku1\resources\resources\views/page/index.blade.php ENDPATH**/ ?>