<div class="container">
    <div class="row">
        <div class="col-lg-8 menu_grid">
            <div class="row">
                <div class="col-lg-12">
                    <img src="<?php echo e(asset('page/assets/images/product/yakiniku.jpg')); ?>"
                        class="imageproduct">
                </div>
                <div class="col-lg-8">
...
</div><?php /**PATH C:\xampp\htdocs\kesiniku1\resources\resources\views/page/order/yakiniku.blade.php ENDPATH**/ ?>