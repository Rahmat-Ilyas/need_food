            ...
            <div class="col-lg-12">
                <div class="box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <?php echo $__env->make('page.order.yakiniku', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        </div>
                                ...
                                <div class="row additional_content_box">
                                    <div class="col-sm-3 grid_element">
                                        <div class="card_additional">
                                            <img src="<?php echo e(asset('page/assets/images/product/additional/additional.png')); ?>"
...
<?php echo $__env->make('headfood.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kesiniku1\resources\resources\views/page/order/index.blade.php ENDPATH**/ ?>