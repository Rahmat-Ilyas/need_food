                        ...
                        <div class="price_card text-center">
                            ...
                            <div class="row" style="padding: 0 10px 0 10px;">
                                <div class="col-md-4 m-l-20" style="padding: 5px;">
                                    <button class="btn btn-block btn-inverse btn-sm waves-effect waves-light" data-toggle="modal" data-target=".modal-set-bahan"><i class="md-shopping-basket"></i> Set Bahan</button>
                                </div>
            ...
            <div class="modal-body" style="padding: 20px 50px 0 50px">
                <form id="fromPaket" action="#">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="nb-edt form-control" required="" autocomplete="off" placeholder="Nama Paket" name="nama">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label">Harga Paket</label>
                        <div class="col-sm-8">
                            <input type="number" class="form-control" required="" autocomplete="off" placeholder="Harga Paket" name="harga">
                        </div>
                    </div>
                    <div class="form-group row">
...
<!-- Modal Set Bahan -->
<div class="modal modal-set-bahan" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 20px 50px 0 50px;">
                <div class="form-group row">
                    <form id="fromPaket" action="#">
                        <div class="col-sm-6">
                            <select class="form-control select2 m-b-20" name="item[]" id="val-set-item" required="">
                                <option value="">Pilih Bahan</option>
                            </select>
                        </div>
                        <div class="col-sm-3">
                            <select class="form-control m-b-20">
                        ...
                        <div class="col-sm-9 text-right" style="margin-top: -10px;">
                            <a href="#" class="btn btn-default btn-sm"><i class="fa fa-plus-circle"></i> Tambah</a>
                        </div>
                    </form>
                </div>
                <hr class="m-t-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="form-inline text-center">
                                    ...
                                    <span><b>pcs</b> /</span>
                                    <input type="number" class="form-control" style="height: 30px; width: 60px;" name="" value="1">
                                    <span><b>pax</b></span>
                                </td>
                                <td>Bahan Utama</td>
                            </tr>
        ...
        $.ajax({
            ...
            success : function(data) {
                $.each(data.result, function(key, val) {
                    ...
                    $('#val-set-item').append('<option value="'+ val.nama +'">'+ val.nama +'</option>');
                });
            }
        });
